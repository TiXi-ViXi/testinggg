        ...
        <div class="nail"></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="fa fa-phone col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>

                            <div class="col-md-6">
                                <input id="email" type="text" autocomplete="on" class="form-control @error('email') is-invalid @enderror username" name="email">
